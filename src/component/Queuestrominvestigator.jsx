...
const TXN_STATUSES = ["completed", "failed", "pending", "reversed"];
...
const SYSTEM_PROMPT = `You are QueueStorm Investigator, an AI copilot for bKash digital finance support agents.
...
export default function QueueStormInvestigator() {
  ...
  const analyze = async () => {
    ...
    const payload = { ticket_id: ticketId, complaint, language, channel, user_type: userType, campaign_context: campaign, transaction_history: transactions };
